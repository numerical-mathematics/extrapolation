                    ...
                    for smoothing in smoothings:
                        ...
                        for robustness in robustnesses:
                            ...
                            for solverFunction in solverFunctions:
                                ...
                                testProblemResult[j].append([finalTime-startTime, maximum_relative_error, fe_tot, nsteps])
                                print("Done: " + labelsFunction[k] + " rel error: " + str(relative_error) + " func eval: " + str(fe_tot) + " num steps: " + str(nsteps))
...
def plotResults(resultDict, labels):
    ...
    for test in getAllTests():
        ...
        for i in range(0,len(resultTest)):
            ...
            yratio=[resRow[4] for resRow in res]
            x=[resRow[1] for resRow in res]
            plt.subplot(411)
        ...
        plt.subplot(413)
        plt.legend()
        plt.ylabel("# function eval. ratio")
        plt.xlabel("relative error (log10)")
        j+=1
    plt.show()
